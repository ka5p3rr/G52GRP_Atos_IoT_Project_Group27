...
public class Main extends Application {
    ...
    /**
     * Set the properties of the WelcomeScreen {@link Scene}. it is provided as a public static method so other classes can go back to this screen. It adds an EventFilter to the scene for quick full-screen toggle using the CTRL-F shortcut.
    ...
    /**
     * Starts the the application by setting the properties of the current {@link Stage}. Also sets the first {@link Scene}.
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/uk/ac/nottingham/fxml/WelcomeScreen.fxml"));
